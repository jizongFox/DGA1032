...
def visual():
    ...
    ax3.hlines(y=((val_curves['background']+val_curves['foregound'])/2).max(),xmin=0,xmax=len(val_curves['background']),colors='g',linestyles='dashed' )
