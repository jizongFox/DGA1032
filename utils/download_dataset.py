...
cmd = '"kaggle datasets download -d jizongpeng/acdc2dall -p %s"'%os.path.join(project_root_path,'dataset')

os.system('/bin/zsh -c '+ cmd)
# subprocess.Popen(cmd, stdout=subprocess.PIPE, shell=True, executable="/bin/zsh")
